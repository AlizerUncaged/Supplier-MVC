...
//         public const string PurchaseOrderHeaders = "PurchaseOrderHeadersINV";
//         public const string PurchaseOrderDetails = "PurchaseOrderDetailsINV";
//
//         /// <summary>
...
//             CreateTableIfNotExist(PurchaseOrderDetails, "Id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, " +
//                                                         "PurchaseOrderHeaderId INTEGER, " +
//                                                         "ProductId INTEGER, " +
//                                                         "Qty INTEGER, " +
//                                                         "Price DECIMAL(18, 2), " +
//                                                         "Amount DECIMAL(18, 2), " +
//                                                         $"FOREIGN KEY(PurchaseOrderHeaderId) REFERENCES {PurchaseOrderHeaders}(Id)");
//
...
//
//             SQLiteDataReader rdr = new SQLiteCommand($"SELECT * FROM {SuppliersExtensionTable}", Connection)
//                 .ExecuteReader();
//
//             while (rdr.Read())
//             {
